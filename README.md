...
| Dev Container producer | [xgic/payload-cms-dev](https://github.com/xgic/payload-cms-dev) |
| End-user template | [xgic/payload-cms](https://github.com/xgic/payload-cms) |

## Status

**0.2.0 — product commands.** Library helpers + nested `xgic payload` command group. Living brand: **XGIC CLI** only (B5 hard cutover complete; no supported `xde` entrypoint). See [ADR-0005](https://github.com/xgic/ai/blob/main/docs/adr/0005-modular-xgic-cli-and-retirement-of-xde.md).
...
### Command map (historical `xde` → XGIC CLI)
